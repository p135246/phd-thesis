...
In \cite{Cieliebak2007}, they sketch a proof that symplectic field theory of the unit cotangent bundle of $M$ and equivariant string topology of $M$ are $\IBLInfty$-quasi-isomorphic via a map induced from evaluations at boundaries of holomorphic curves. String topology operations then arise naturally from the codimension $1$ boundary structure of the moduli space of holomorphic curves with certain boundary conditions. In fact, a precise formulation of this correspondence was perhaps the main reason for Cieliebak \& Latschev to think about the $\IBLInfty$-chain model of string topology.\ToDo[caption={Precise formulation of SFT},noline]{How is it precisely, what kind of boundary conditions and punctures?}
