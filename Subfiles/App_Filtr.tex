...
\begin{Remark}[Exponential and logarithm in $\Star$]\phantomsection\label{Rem:ExpLogStar}
\begin{RemarkList}
...
\begin{Definition}[Complete filtered $\IBLInfty$-algebra in $\MV$-formalism]\phantomsection\label{Def:ComplFiltrIBL}
...
\begin{Questions}\phantomsection\label{Q:SomeQuestionsFilter}\begin{RemarkList}
