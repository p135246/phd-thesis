...
\Add[inline,caption={DONE Simplify string top. and cyc. hom. comparison}]{Add somewhere that the map from $(\CDBCyc \HDR(M),b^*)$ to $(C(\StringSpace M),\Bdd)$ with no degree shifts does the job (after removing all degree shifts from definitions).}
