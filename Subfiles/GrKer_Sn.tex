...
%\begin{itemize}
%\item Is a coexact solution of $\Dd \GKer = H$ which smoothly extends to the blow-up unique?
...
%
%It does not hold that every solution of the equation $\Dd \GKer = \HKer$ defines a Green operator!. But those who extend smoothly to the blow-up yes.
%\end{itemize}}
