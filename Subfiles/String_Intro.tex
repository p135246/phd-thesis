...
\Correct[caption={DONE Mistake in reduced notation}]{Correct the notation here, if it is not already corrected.
Anyway, define something like RedNTwistHIBL and replace the construction.}
